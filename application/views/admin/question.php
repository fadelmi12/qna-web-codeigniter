            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html"> <img alt="image" src="<?php echo base_url(); ?>assets/admin/img/logo.png" class="header-logo" /> <span class="logo-name">Otika</span>
                        </a>
                    </div>
                        ...
                        <div class="col-12 col-sm-12 col-lg-12">
                            <div class="card ">
                                <div class="card-header">
                                    <h4 class="text-left">Pertanyaan</h4>
                                                        ...
                                                        <div class="row ">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-0">
                                                                ...
                                                                <div class="card-content">
                                                                    ...
                                                                    <h4 class="mb-1" style="font-size:15px"><?php echo $ktg['pertanyaan'] ?></h4>
                                                                    <p class="mb-0">User :<span class="col-green"><?php echo $ktg['nama_user'] ?></span></p>
                                                                    
                                                                </div>
                                                                
                                                            </div>
                                                            <div class="col-lg-6 col-md-3 col-sm-3 col-xs-2 pl-0">
                                                            <div class="d-flex flex-row-reverse bd-highlight">
                                                        
                                                                <a href="#" class="btn btn-primary mt-2 mb-2 m-1">View Question</a>
                                                                <button type="button"  class="btn btn-info mt-2 mb-2 m-1">Edit</button>
