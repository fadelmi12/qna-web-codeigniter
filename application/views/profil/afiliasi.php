                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            <tr>
                                <th>No</th>
                                <th>User Afiliasi</th>
                                <th>Penambahan Coin</th>
                                <th>Waktu Afiliasi</th>
                            </tr>
                            <tr>
                                <?php $i = 1;
                                foreach ($afiliasi as $afl) : ?>
                                    <td><?php echo $i ?></td>
                                    <td><?php echo $afl['nama_user'] ?></td>
                                    <td><?php echo $afl['koin'] ?> Coin</td>
                                    <td><?php echo $afl['tgl_afiliasi'] ?></td>
                                <?php $i++;
                                endforeach; ?>
                            </tr>
                        </table>
