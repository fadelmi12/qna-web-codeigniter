                            ...
                            <li class="p-3">
                                <div class="d-block w-100">
                                    <div class="text-center">
                                        <h5 class="m-0">
                                            Belum ada pertanyaan yang kamu simpan nih :)<br>
                                            yuk lihat daftar <a href="<?php echo base_url() ?>Pertanyaan" title="daftar pertanyaan">pertanyaan lainnya...</a>
                                        </h5>
                                    </div>
                                </div>
                            </li>
                        <?php else : ?>
                            <?php foreach ($bookmark as $bmk) :
                                date_default_timezone_set('Asia/Jakarta');
                                $awal  = date_create($bmk['waktu_question']);
                                $akhir = date_create();
                                        ...
                                        <div class="d-block w-100">
                                            <div class="d-flex justify-content-between ">
                                                <div class="user mb-2">
                                                    <div class="nama">
                                                        <h5>
                                                            <?php echo $bmk['nama_user'] ?>
                                                        </h5>
                                                    </div>
                                                    <div class="upload mt-1">
                                                        <h6>
                                                            <span class="d-none d-sm-inline-block"><?php echo $bmk['nama_kategori'] ?> ,</span> <a href=""><?php echo $time ?> yang lalu</a>
                                                        </h6>
                                                    </div>
                                                </div>
                                                <div class="harga">
                                                    <h6>
                                                        <span style="margin-right:.3rem;"></span><?php echo $bmk['harga'] ?> Coin
                                                    </h6>
                                                </div>
                                            </div>
                                            <div class="pertanyaan">
                                                <a href="<?php echo base_url('Pertanyaan/detail/' . $bmk['id_pertanyaan']) ?>">
                                                    <h5>
                                                        <?php echo $bmk['pertanyaan'] ?>
                                                    </h5>
                                                </a>
                                            </div>
                                        </div>
